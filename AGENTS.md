...
- [ ] **Verifikasi packaging (T4, rencana user)**: di venv bersih, `pip install -e .` lalu `dn-bot --help` dan `python -m dn_bot --help` dari folder luar root proyek — konfirmasi console script + import lintas-cwd (tes lokal sudah mensimulasikan lewat subprocess PYTHONPATH).
