...
- `.env.example` dibersihkan (baris `[TEMPLATE]` artefak dihapus) dan menambahkan `DN_INSTRUCTION` (variabel yang didukung sejak T3); `OPENAI_TIMEOUT` sudah tercantum sebelumnya.
