...
- [ ] **Verifikasi fresh venv** (rencana user): `python -m venv` baru → `pip install -r requirements-dev.txt` → `pytest -q` → harapannya **125 passed** (membuktikan pin versi di lingkungan bersih).
